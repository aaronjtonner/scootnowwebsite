...
module.exports = {
  siteMetadata: {
    ...
    url: "https://www.scootnow.ca", // No trailing slash allowed!
    siteUrl: "https://www.scootnow.ca",
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        url: "http://www.scootnow.purpleparrotwebsites.com/graphql",
        html: {
          imageMaxWidth: 1024,
        },
        schema: {
